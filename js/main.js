...
const land = 5000,
      ...
      window.addEventListener('DOMContentLoaded', function() {
        ...
        counterBlock.addEventListener('keyup', () => {
            counterHours.value = '';
            counterRate.value = '';
        ...
        counterPages.addEventListener('keyup', () => {
            counterHours.value = '';
            counterRate.value = '';

            total = counterPages.value * blocks;
            totalValue.value = total;
        });

        counterHours.addEventListener('keyup', () => {
            counterBlock.value = '';
            counterPages.value = '';
            total = 0;
        ...
        counterRate.addEventListener('keyup', () => {
            counterBlock.value = '';
            counterPages.value = '';
            total = 0;
            hourRate = time * counterRate.value;
